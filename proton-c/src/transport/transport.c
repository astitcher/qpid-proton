...
{
  assert(transport);
  pn_context_set(transport->context, PN_LEGCTX, context);
}

void *pn_transport_get_context(pn_transport_t *transport)
{
  assert(transport);
  return pn_context_get(transport->context, PN_LEGCTX);
}

pn_context_t *pn_transport_context(pn_transport_t *transport)
{
  assert(transport);
