...
def pn_decref(object: pn_object_t) -> int: ...
def pn_tostring(object: pn_object_t) -> CData: ...
...
def pn_event_type(event: pn_event_t) -> int: ...
def pn_event_type_name(type: int) -> CData: ...
def pn_incref(object: pn_object_t) -> pn_object_t: ...
...
def init() -> None: ...
def pn_cast_pn_connection(x: pn_object_t) -> pn_connection_t: ...
def pn_cast_pn_session(x: pn_object_t) -> pn_session_t: ...
def pn_cast_pn_link(x: pn_object_t) -> pn_link_t: ...
def pn_cast_pn_delivery(x: pn_object_t) -> pn_delivery_t: ...
def pn_cast_pn_transport(x: pn_object_t) -> pn_transport_t: ...
def pn_pyref_incref(object: CData) -> None: ...
def pn_pyref_decref(object: CData) -> None: ...
def pn_pytracer(transport: pn_transport_t, message: bytes) -> None: ...
def pn_collector_put_py(collector: pn_collector_t, context: Any, type: pn_event_type_t | int) -> pn_event_t: ...
