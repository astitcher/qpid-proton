 ...
 *
 * Both limits are set to conservative defaults on construction to guard
 * against large allocations from malicious or malformed peer data.
 * Applications decoding legitimately large data (e.g. very large property
 * maps) may raise the limits with this function.
 *
